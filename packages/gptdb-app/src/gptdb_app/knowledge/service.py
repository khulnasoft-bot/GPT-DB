...
from gptdb_ext.rag.assembler.summary import SummaryAssembler
from gptdb_ext.rag.chunk_manager import ChunkParameters
from gptdb_ext.rag.knowledge.factory import KnowledgeFactory
from gptdb_serve.rag.models.chunk_db import DocumentChunkDao, DocumentChunkEntity
from gptdb_serve.rag.models.document_db import (
    KnowledgeDocumentDao,
    KnowledgeDocumentEntity,
)
from gptdb_serve.rag.models.models import KnowledgeSpaceDao, KnowledgeSpaceEntity
from gptdb_serve.rag.retriever.knowledge_space import KnowledgeSpaceRetriever
from gptdb_serve.rag.service.service import SyncStatus
...
class KnowledgeService:
    ...
    def _build_default_context(self):
        from gptdb_app.scene.chat_knowledge.v1.prompt import (
            _DEFAULT_TEMPLATE,
            PROMPT_SCENE_DEFINE,
        )
    ...
    async def _llm_extract_summary(
        ...
        """
        from gptdb_app.scene import ChatParam, ChatScene
        ...
        from gptdb_app.openapi.api_v1.api_v1 import CHAT_FACTORY
    ...
    def get_retrieve_strategy_list(self) -> List[Dict]:
        ...
        retrieve strategy: gptdb.rag.retriever.base.RetrieverStrategy
        """
        return [
