...
from gptdb_app.scene import BaseChat, ChatScene
from gptdb_app.scene.base_chat import ChatParam
from gptdb_app.scene.chat_knowledge.v1.config import ChatKnowledgeConfig
...
class ChatKnowledge(BaseChat):
    ...
    def __init__(self, chat_param: ChatParam, system_app: SystemApp):
        ...
        from gptdb_serve.rag.models.models import (
            KnowledgeSpaceDao,
        )
    ...
    def get_knowledge_search_top_size(self, space_name) -> int:
        ...
        if len(spaces) == 1:
            from gptdb_ext.storage import __knowledge_graph__ as graph_storages
