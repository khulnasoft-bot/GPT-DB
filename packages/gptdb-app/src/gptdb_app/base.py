...
from gptdb.core.interface.parameter import BaseServerParameters
...
from gptdb_app.config import ApplicationConfig, ServiceConfig
...
def _migration_db_storage(
    ...
    if not disable_alembic_upgrade:
        ...
        if (
            ...
            init and upgrade. "
                "1.If you are use GPT-DB firstly, please manually execute the following\
                 command to initialize, 
                `mysql -h127.0.0.1 -uroot -p{your_password} \
                < ./assets/schema/gptdb.sql` "
