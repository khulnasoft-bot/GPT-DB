...
from gptdb_serve.agent.agents.expand.actions.metric_info_action import (
    MetricInfoAction,
)
...
class MetricInfoAgent(ConversableAgent):
    ...
    profile: ProfileConfig = ProfileConfig(
        name=DynConfig(
            "MetricInfoRetriever",
            category="agent",
            key="gptdb_ant_agent_agents_metric_info_agent_profile_name",
        ),
        role=DynConfig(
            "MetricInfoRetriever",
            category="agent",
            key="gptdb_ant_agent_agents_metric_info_agent_profile_role",
        ),
        goal=DynConfig(
            ...
            "and thresholds.",
            category="agent",
            key="gptdb_ant_agent_agents_metric_info_agent_profile_goal",
        ),
        constraints=DynConfig(
            ...
            category="agent",
            key="gptdb_ant_agent_agents_metric_info_agent_profile_constraints",
        ),
        desc=DynConfig(
            ...
            "指标信息。",
            category="agent",
            key="gptdb_ant_agent_agents_metric_info_agent_profile_desc",
        ),
    )
