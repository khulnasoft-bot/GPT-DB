...
from gptdb_serve.agent.agents.expand.actions.anomaly_detection_action import (
...
class AnomalyDetectionAgent(ConversableAgent):
    ...
    profile: ProfileConfig = ProfileConfig(
        name=DynConfig(
            "AnomalyDetector",
            category="agent",
            key="gptdb_ant_agent_agents_anomaly_detection_agent_profile_name",
        ),
        role=DynConfig(
            "AnomalyDetector",
            category="agent",
            key="gptdb_ant_agent_agents_anomaly_detection_agent_profile_role",
        ),
        goal=DynConfig(
            ...
            category="agent",
            key="gptdb_ant_agent_agents_anomaly_detection_agent_profile_goal",
        ),
        constraints=DynConfig(
            ...
            category="agent",
            key="gptdb_ant_agent_agents_anomaly_detection_agent_profile_constraints",
        ),
        desc=DynConfig(
            ...
            "发生显著异常。",
            category="agent",
            key="gptdb_ant_agent_agents_anomaly_detection_agent_profile_desc",
        ),
    )
