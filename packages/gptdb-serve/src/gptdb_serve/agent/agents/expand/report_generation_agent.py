...
from gptdb_serve.agent.agents.expand.actions.report_generation_action import (
...
class ReportGenerationAgent(ConversableAgent):
    ...
    profile: ProfileConfig = ProfileConfig(
        name=DynConfig(
            "ReportGenerator",
            category="agent",
            key="gptdb_ant_agent_agents_report_generation_agent_profile_name",
        ),
        role=DynConfig(
            "ReportGenerator",
            category="agent",
            key="gptdb_ant_agent_agents_report_generation_agent_profile_role",
        ),
        goal=DynConfig(
            ...
            category="agent",
            key="gptdb_ant_agent_agents_report_generation_agent_profile_goal",
        ),
        constraints=DynConfig(
            ...
            category="agent",
            key="gptdb_ant_agent_agents_report_generation_agent_profile_constraints",
        ),
        desc=DynConfig(
            ...
            "明确依赖前面所有相关步骤的输出。",
            category="agent",
            key="gptdb_ant_agent_agents_report_generation_agent_profile_desc",
        ),
    )
