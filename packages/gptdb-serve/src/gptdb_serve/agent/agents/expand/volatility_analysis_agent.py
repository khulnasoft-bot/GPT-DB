...
from gptdb_serve.agent.agents.expand.actions.volatility_analysis_action import (
...
class VolatilityAnalysisAgent(ConversableAgent):
    ...
    profile: ProfileConfig = ProfileConfig(
        name=DynConfig(
            "VolatilityAnalyzer",
            category="agent",
            key="gptdb_ant_agent_agents_volatility_analysis_agent_profile_name",
        ),
        role=DynConfig(
            "VolatilityAnalyzer",
            category="agent",
            key="gptdb_ant_agent_agents_volatility_analysis_agent_profile_role",
        ),
        goal=DynConfig(
            ...
            category="agent",
            key="gptdb_ant_agent_agents_volatility_analysis_agent_profile_goal",
        ),
        constraints=DynConfig(
            ...
            category="agent",
            key="gptdb_ant_agent_agents_volatility_analysis_agent_profile_constraints",
        ),
        desc=DynConfig(
            ...
            "不得在未检测到异常时主动执行归因。",
            category="agent",
            key="gptdb_ant_agent_agents_volatility_analysis_agent_profile_desc",
        ),
    )
