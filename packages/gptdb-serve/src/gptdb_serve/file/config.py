...
from gptdb.core.interface.file import StorageBackendConfig
from gptdb.util.i18n_utils import _
from gptdb.util.module_utils import ScannerConfig
...
@auto_register_resource(
    ...
    description=_(
        "This configuration is for the file serve module. In GPT-DB, you can store your"
...
class ServeConfig(BaseServeConfig):
    ...
    __scan_config__ = ScannerConfig(
        module_path="gptdb_ext.storage.file",
