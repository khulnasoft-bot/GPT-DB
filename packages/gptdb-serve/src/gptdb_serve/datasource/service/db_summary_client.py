...
from gptdb_ext.rag.summary.gdbms_db_summary import GdbmsSummary
from gptdb_ext.rag.summary.rdbms_db_summary import RdbmsSummary
...
class DBSummaryClient:
    ...
    def init_db_profile(self, db_summary_client, dbname):
        ...
        if not table_vector_connector.vector_name_exists():
            ...
            from gptdb_ext.rag.summary.rdbms_db_summary import _DEFAULT_COLUMN_SEPARATOR
