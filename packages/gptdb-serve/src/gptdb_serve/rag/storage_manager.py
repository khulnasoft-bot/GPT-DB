...
from gptdb import BaseComponent
...
from gptdb_ext.storage.knowledge_graph.knowledge_graph import BuiltinKnowledgeGraph
        ...
        if storage_type.lower() in supported_vector_types:
            ...
            if not storage_config.graph:
                raise ValueError(
                    ...
                    "   python gptdb_server.py --config configs/gptdb-graphrag.toml\n"
            ...
            if not storage_config.full_text:
                raise ValueError(
                    ...
                    "   python gptdb_server.py --config configs/gptdb-bm25-rag.toml\n"
