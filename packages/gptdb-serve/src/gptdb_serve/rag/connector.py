...
from gptdb_ext.storage import __document_store__ as supported_full_tet_list
from gptdb_ext.storage import __knowledge_graph__ as supported_kg_store_list
from gptdb_ext.storage import __vector_store__ as supported_vector_store_list
...
class VectorStoreConnector:
    ...
    def from_default(
        ...
        from gptdb_ext.storage.vector_store.chroma_store import ChromaVectorConfig
    ...
    def _register(self):
        from gptdb_ext.storage import __all__ as rag_storages
        from gptdb_ext.storage import _select_rag_storage
