...
from gptdb.core import Chunk, Document, LLMClient
...
from gptdb_ext.rag.retriever.doc_tree import TreeNode
from gptdb_serve.rag.models.models import KnowledgeSpaceDao
from gptdb_serve.rag.retriever.qa_retriever import QARetriever
from gptdb_serve.rag.retriever.retriever_chain import RetrieverChain
...
class KnowledgeSpaceRetriever(BaseRetriever):
    ...
    def rag_service(self):
        from gptdb_serve.rag.service.service import Service as RagService
    ...
    async def tree_index_retrieve(
        ...
        try:
            ...
            from gptdb_ext.rag.retriever.doc_tree import DocTreeRetriever
