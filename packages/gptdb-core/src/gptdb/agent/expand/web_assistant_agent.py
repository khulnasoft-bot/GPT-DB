...
class WebSearchAgent(ConversableAgent):
    ...
    profile: ProfileConfig = ProfileConfig(
        name=DynConfig(
            ...
            category="agent",
            key="gptdb_agent_expand_data_aware_search_agent_profile_name",
        ),
        role=DynConfig(
            "SearchNeedEvaluator",
            category="agent",
            key="gptdb_agent_expand_data_aware_search_agent_profile_role",
        ),
        goal=DynConfig(
            ...
            category="agent",
            key="gptdb_agent_expand_data_aware_search_agent_profile_goal",
        ),
        constraints=DynConfig(
            ...
            category="agent",
            key="gptdb_agent_expand_data_aware_search_agent_profile_constraints",
        ),
        desc=DynConfig(
            ...
            category="agent",
            key="gptdb_agent_expand_data_aware_search_agent_profile_desc",
        ),
    )
