...
class Excel2TableAgent(ConversableAgent):
    ...
    profile: ProfileConfig = ProfileConfig(
        name=DynConfig(
            "ExcelScientistAgent",
            category="agent",
            key="gptdb_agent_expand_excel2table_agent_profile_name",
        ),
        role=DynConfig(
            "ExcelScientist",
            category="agent",
            key="gptdb_agent_expand_excel2table_agent_profile_role",
        ),
        goal=DynConfig(
            ...
            "insertion.",
            category="agent",
            key="gptdb_agent_expand_excel2table_agent_profile_goal",
        ),
        constraints=DynConfig(
            ...
            category="agent",
            key="gptdb_agent_expand_excel2table_agent_profile_constraints",
        ),
        desc=DynConfig(
            ...
            category="agent",
            key="gptdb_agent_expand_excel2table_agent_profile_desc",
        ),
    )
