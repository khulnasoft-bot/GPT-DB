...
if TYPE_CHECKING:
    from gptdb.model.proxy.llms.aimlapi import AimlapiLLMClient
    from gptdb.model.proxy.llms.burncloud import BurnCloudLLMClient
    ...
    from gptdb.model.proxy.llms.infiniai import InfiniAILLMClient
...
def __lazy_import(name):
    module_path = {
        ...
        "BurnCloudLLMClient": "gptdb.model.proxy.llms.burncloud",
        "ClaudeLLMClient": "gptdb.model.proxy.llms.claude",
        "GeminiLLMClient": "gptdb.model.proxy.llms.gemini",
        "AimlapiLLMClient": "gptdb.model.proxy.llms.aimlapi",
        ...
        "InfiniAILLMClient": "gptdb.model.proxy.llms.infiniai",
    }
