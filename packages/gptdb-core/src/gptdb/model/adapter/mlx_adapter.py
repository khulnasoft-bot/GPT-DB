...
from gptdb.model.adapter.model_metadata import COMMON_HF_MODELS
from gptdb.model.adapter.template import ConversationAdapter
...
class MLXModelAdapter(LLMModelAdapter):
    ...
    def get_generate_stream_function(
        ...
        from gptdb.model.llm.llm_out.mlx_llm import generate_stream
