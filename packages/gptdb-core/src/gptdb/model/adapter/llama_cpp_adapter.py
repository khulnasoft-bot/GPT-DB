...
from gptdb.model.adapter.base import (
    ConversationAdapter,
    LLMModelAdapter,
    register_model_adapter,
)
from gptdb.model.adapter.model_metadata import COMMON_LLAMA_CPP_MODELS
...
class LLamaServerModelAdapter(LLMModelAdapter):
    ...
    def get_generate_stream_function(
        ...
        from gptdb.model.llm.llama_cpp.llama_cpp_server import generate_stream
    ...
    def get_generate_function(
        ...
        from gptdb.model.llm.llama_cpp.llama_cpp_server import generate
