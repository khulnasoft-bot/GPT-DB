...
from gptdb.model.adapter.model_metadata import (
...
class NewHFChatModelAdapter(LLMModelAdapter, ABC):
    ...
    def get_generate_stream_function(
        ...
        from gptdb.model.llm.llm_out.hf_chat_llm import huggingface_chat_generate_stream
    ...
    def load_media(self, params: Dict, messages: List[ModelMessage]):
        ...
        """
        from gptdb.model.utils.media_utils import parse_messages
