...
from gptdb.core.interface.file import StorageBackend, StorageBackendConfig
...
class OSSStorageConfig(StorageBackendConfig):
    ...
    fixed_bucket: Optional[str] = field(
        ...
        metadata={
            "help": _(
                "The fixed bucket name to use. If set, all logical buckets in GPT-DB "
    ...
    bucket_prefix: Optional[str] = field(
        ...
        metadata={
            "help": _(
                "The prefix of the bucket name. If set, all logical buckets in GPT-DB "
