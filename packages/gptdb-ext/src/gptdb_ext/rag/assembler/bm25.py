...
from gptdb_ext.rag.assembler.base import BaseAssembler
from gptdb_ext.rag.chunk_manager import ChunkParameters
from gptdb_ext.rag.retriever.bm25 import BM25Retriever
...
class BM25Assembler(BaseAssembler):
    ...
    .. code-block:: python
        ...
        from gptdb_ext.rag.assembler import BM25Assembler
