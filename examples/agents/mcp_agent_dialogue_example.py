...
from gptdb.agent.resource import AutoGPTPluginToolPack, MCPToolPack
from gptdb.configs.model_config import ROOT_PATH
from gptdb.model.proxy import SiliconFlowLLMClient
...
async def main():
    ...
    # 2.bind gptdb resource MCPToolPack use mcp sse server lisk this：
