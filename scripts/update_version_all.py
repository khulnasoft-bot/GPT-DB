...
# ///
"""
Enhanced interactive version update script for gptdb-mono project.
...
Examples:
  ...
  uv run version_update.py 0.8.0 --filter gptdb-core  # Only update gptdb-core package
"""
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description="Update version numbers across the gptdb-mono project",
