# Multimodal Support in GPT-DB

GPT-DB supports multimodal capabilities, allowing you to work with various data types such as text, images, and audio. This guide will help you set up and use multimodal features in GPT-DB.
...
```bash
uv run gptdb start webserver --config {your_config_file}
```

### Step 4: Use The Model In GPT-DB

Now, GPT-DB just support image input, and only the `Chat Normal` scenario is supported.
...
<p align="left">
  <img src={'/img/installation/advanced_usage/gptdb-multimodal-local.jpg'} width="720px"/>
</p>
...
<p align="left">
  <img src={'/img/installation/advanced_usage/gptdb-multimodal-proxy.jpg'} width="720px"/>
</p>
