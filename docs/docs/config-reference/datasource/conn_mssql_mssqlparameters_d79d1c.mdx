...
<ConfigDetail config={{
  ...
  "parameters": [
    ...
    },
    {
      ...
      "type": "string",
      "required": false,
      "description": "Database password, you can write your password directly, of course, you can also use environment variables, such as ${env:GPTDB_DB_PASSWORD}",
      "defaultValue": "${env:GPTDB_DB_PASSWORD}"
    },
    {
      "name": "pool_size",
      "type": "integer",
