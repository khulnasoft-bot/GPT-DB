...
<ConfigClassTable classes={[
  ...
  {
    "name": "ServeConfig",
    "description": "This configuration is for the hub gptdbs serve module.",
    "link": "./config_serveconfig_ec2d70"
  },
  {
    "name": "ServeConfig",
    "description": "This configuration is for the my gptdbs serve module.",
  ...
  {
    "name": "ServeConfig",
    "description": "This configuration is for the file serve module. In GPT-DB, you can store yourfiles in the file server.",
