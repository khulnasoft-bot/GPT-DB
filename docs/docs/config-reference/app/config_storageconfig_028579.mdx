...
description: "StorageConfig(vector: Optional[gptdb_ext.storage.vector_store.chroma_store.ChromaVectorConfig] = <factory>, graph: Optional[gptdb_ext.storage.graph_store.tugraph_store.TuGraphStoreConfig] = None, full_text: Optional[gptdb_ext.storage.vector_store.elastic_store.ElasticsearchStoreConfig] = None)"
---
