...
description: "ModelsDeployParameters(default_llm: Optional[str] = None, default_embedding: Optional[str] = None, default_reranker: Optional[str] = None, llms: List[gptdb.core.interface.parameter.LLMDeployModelParameters] = <factory>, embeddings: List[gptdb.core.interface.parameter.EmbeddingDeployModelParameters] = <factory>, rerankers: List[gptdb.core.interface.parameter.RerankerDeployModelParameters] = <factory>)"
---
