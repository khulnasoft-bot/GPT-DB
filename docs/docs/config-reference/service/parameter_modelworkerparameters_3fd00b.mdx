...
<ConfigDetail config={{
  ...
  "parameters": [
    ...
    },
    {
      ...
      "type": "string",
      "required": false,
      "description": "Model worker class, gptdb.model.cluster.DefaultModelWorker"
    },
    {
      "name": "standalone",
      "type": "boolean",
