...
description: "ModelControllerParameters(host: Optional[str] = '0.0.0.0', port: Optional[int] = 8000, daemon: Optional[bool] = False, log: gptdb.util.utils.LoggingParameters = <factory>, trace: Optional[gptdb.util.tracer.tracer_impl.TracerParameters] = None, registry: Optional[gptdb.model.parameter.BaseModelRegistryParameters] = None, heartbeat_interval_secs: Optional[int] = 20, heartbeat_timeout_secs: Optional[int] = 60)"
---
