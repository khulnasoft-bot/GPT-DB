...
For quick usage reference: [http://docs.gptdb.cn/docs/next/quickstart](http://docs.gptdb.cn/docs/next/quickstart)
...
For all configurations reference: [http://docs.gptdb.cn/docs/next/config-reference/app/config_chatdashboardconfig_2480d0](http://docs.gptdb.cn/docs/next/config-reference/app/config_chatdashboardconfig_2480d0)
...
For detailed configuration instructions, please refer to: [http://docs.gptdb.cn/docs/next/config-reference/utils/config_s3storageconfig_f0cdc9](http://docs.gptdb.cn/docs/next/config-reference/utils/config_s3storageconfig_f0cdc9)
...
For details, see the documentation: [http://docs.gptdb.cn/docs/next/installation/docker-build-guide](http://docs.gptdb.cn/docs/next/installation/docker-build-guide)
...
[概览](https://www.yuque.com/eosphoros/gptdb-docs/bex30nsv60ru0fmx)


## ✨Acknowledgements
Thanks to all contributors for making this release possible!

**283569391@qq.com, @15089677014, @Aries-ckt, @FOkvj, @Jant1L, @SonglinLyu, @TenYearOldJAVA, @Weaxs, @cinjoseph, @khulnasoft, @damonqin, @dusx1981, @fangyinc, @geebytes, @haawha, @utopia2077, @vnicers, @xuxl2024, @yhjun1026, @yunfeng1993, @yyhhyyyyyy and tam**
...
## ✨Appendix
+ [Quick Start](http://docs.gptdb.cn/docs/next/quickstart)
+ [Docker Quick Deployment](http://docs.gptdb.cn/docs/next/installation/docker)