...
class I18N:
    ...
    TRANSLATIONS = {
        "en": {
            ...
            "welcome": "Welcome to GPT-DB Installation Assistant!",
...
def get_deployment_presets():
    ...
    return {
        i18n.get("openai_preset"): {
            "extras": ["base", "proxy_openai", "rag", "storage_chromadb", "gptdbs"],
            "config": "configs/gptdb-proxy-openai.toml",
            "description": i18n.get("openai_desc"),
            "note": i18n.get("openai_note"),
        },
        i18n.get("deepseek_preset"): {
            "extras": ["base", "proxy_openai", "rag", "storage_chromadb", "gptdbs"],
            "config": "configs/gptdb-proxy-deepseek.toml",
        ...
        i18n.get("glm4_preset"): {
            ...
            "config": "configs/gptdb-local-glm.toml",
        ...
        i18n.get("vllm_preset"): {
            ...
            "config": "configs/gptdb-local-vllm.toml",
        ...
        i18n.get("llama_cpp_preset"): {
            ...
            "config": "configs/gptdb-local-llama-cpp.toml",
            "description": i18n.get("llama_cpp_desc"),
            "note": i18n.get("llama_cpp_note"),
        },
        i18n.get("ollama_preset"): {
            "extras": ["base", "proxy_ollama", "rag", "storage_chromadb", "gptdbs"],
            "config": "configs/gptdb-proxy-ollama.toml",
...
def _interactive_install_guide(extras: Dict[str, Any], use_china_mirror: bool = False):
    ...
    if preset_info.get("config"):
        ...
        click.echo(f"uv run gptdb start webserver --config {preset_info['config']}")
